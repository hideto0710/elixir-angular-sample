defmodule FridayFront do
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: FridayFront.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    FridayFront.Endpoint.config_change(changed, removed)
    :ok
  end
end
